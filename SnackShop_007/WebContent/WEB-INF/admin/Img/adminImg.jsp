...
<link href="${pageContext.request.contextPath}/css/libs/sweetalert.css"
	rel="stylesheet" type="text/css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/libs/bootstrap.min.css">
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/libs/sweetalert.min.js"></script>
	...
	<div ng-controller="adminImgCtrl">
		...
		<form id="indexPic" method="post">
			<table>
				...
				<tr>
					<td>请需要替换的图片:</td>
					<td><select id="fileName" class="form-control">
				...
				<tr>
					<td><input type="button" id="uploadPic" value="替换"
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/views/adminJs/adminImg.js"></script>
</html>